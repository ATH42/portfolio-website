    ...
    <Container>
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          ...
          Web-Designer with a passion for solving Real World Problems with code.
          His distinct need for cognition in tandem with a calm and focused mind
          let him reach goals efficiently. When not online, he is probably out
          being partners in Crime with his 1 1/2 year old daughter. Currently,
          he is working on an Online Store called {'Studio Scherben'}.
          {/*TODO add linl */}
        </Paragraph>
      ...
      <Section delay={1}>
        ...
        <Divider w={2} m={2} />
        <Paragraph>
          Art and Painting Miniatures, Music, Dungeons & Dragons, Gaming, Being
          a Dad, Coding on weekends, fast bikes, lakes.
        </Paragraph>
        <Paragraph></Paragraph>
      </Section>
    </Container>
